...
struct blockcolors *init_block_colors(bool alternate_level_colors) {
    ...
    const static struct block_init blocks[] = {
        ...
        {62, "burning furnace",        BC_TOP_GRADIENT,
                {192, 192, 192, 255}, { 40,  40,  40, 255}},
        {63, "sign post",              BC_TOP_SINGLE,
                {191, 146, 180, 255}},
        {64, "wooden door (bottom}",   BC_TOP_SINGLE,
                {191, 146, 180, 255}},
        ...
        {71, "iron door (bottom}",     BC_TOP_SINGLE,
                { 25,  25, 144, 180}},
        ...
        {84, "jukebox",                BC_TOP_SINGLE,
                {160, 162, 189, 255}},
        {85, "fence",                  BC_TOP_SINGLE,
                {191, 146, 180, 255}},
        {86, "pumpkin",                BC_TRANSPARENT},
        {87, "bloodstone",             BC_TOP_GRADIENT,
                { 71,  21,  21, 255}, {144,  82,  82, 255}},
        {88, "slowsand",               BC_TOP_SINGLE,
                {118,  99,  86, 255}},
        {89, "lightstone",             BC_TOP_SINGLE,
                {215, 159,  79, 255}},
        {90, "portal",                 BC_TRANSPARENT},
        {91, "jack-o-lantern",         BC_TRANSPARENT},
    ...
    static const uint8_t sideshade[4] = {0, 0, 0, 80};
    static const uint8_t levelshade[4] = {0, 0, 0, 20};
